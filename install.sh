...
# The orginal script is from Adafruit and mentioned in the documentation of their RGB MATRIX BONNET OR HAT!
# I have modified this script for my own project.
# The original script has been published here: https://github.com/adafruit/Raspberry-Pi-Installer-Scripts

GITUSER=https://github.com/hzeller
REPO=rpi-rgb-led-matrix
COMMIT=63e3e7ffdbe88223cc80e1faa508bc4f3cf2bea4
...
echo "Project-pxl-client"
echo "It has been modified for to work with my project."
echo "Steps include:"
echo "- Install prerequisite software"
echo "- Install RGB matrix driver software and examples"
echo "- Install my own software"
...
cp -r $REPO-$COMMIT rpi-rgb-led-matrix
rm -r $REPO-$COMMIT
